...
def generate_launch_description():
    ...
    if camera_type == "usb":
        ...
        feedback_picture_arg = DeclareLaunchArgument(
            'video',
            default_value='./config/palace.mp4',
            description='feedback video')
        ...
        fb_node = IncludeLaunchDescription(
            ...
            launch_arguments={
                'publish_image_source': LaunchConfiguration('video'),
                'publish_image_format': 'mp4',
    ...
    web_node = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'websocket_smart_topic': '/yolo_tracker_res'
        }.items()
    )
